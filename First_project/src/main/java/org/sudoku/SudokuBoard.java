<<<<<<< HEAD:First_project/src/main/java/org/sudoku/SudokuBoard.java
...
public class SudokuBoard {
    ...
    public void printBoard() {
        for (int i = 0; i < 9; i++) {
            for (int j = 0; j < 9; j++) {
                System.out.print(sudokuBoard[i][j].getFieldValue() + " ");
            }
            System.out.println();
        }
    }
...
>>>>>>> 4f10de027d768af12fa63ca031263d083208cc20:First_project/src/main/java/org/example/SudokuBoard.java
